...
var mediaScreen = window.matchMedia("(min-width:901px) and (max-width:1200px)");
...
confirm.addEventListener('click', function () {
    ...
    var slide8 = document.createElement('div');
    slide8.classList.add("slide-item");
    var slide9 = document.createElement('div');
    slide9.classList.add("slide-item");
    var slide10 = document.createElement('div');
    slide10.classList.add("slide-item");
    var slide11 = document.createElement('div');
    slide11.classList.add("slide-item");
    var slide12 = document.createElement('div');
    slide12.classList.add("slide-item");
    var slide13 = document.createElement('div');
    slide13.classList.add("slide-item");
    var slide14 = document.createElement('div');
    slide14.classList.add("slide-item");
    var slide15 = document.createElement('div');
    slide15.classList.add("slide-item");

    var inputData = document.getElementById("search-input").value;

    _superagent2.default.get('https://www.googleapis.com/youtube/v3/search').query({
        q: inputData
    }).query({
        ...
        if (err || !res1.ok) {
            ...
            var answerItems = res1.body.items;
            _lodash2.default.forEach(answerItems, function (item, i) {

                _superagent2.default.get('https://www.googleapis.com/youtube/v3/videos').query({
                    id: item.id.videoId
                }).query({
                    key: 'AIzaSyCTWC75i70moJLzyNh3tt4jzCljZcRkU8Y'
                }).query('part=snippet,statistics,contentDetails,player').end(function (err, res2) {
                    if (err || !res2.ok) {
                        console.log('Oh no! error');
                    } else {
                        var createAnswer = function createAnswer(item) {
                        ...
                        var slideFiller = function slideFiller(screen) {
                        ...
                        var ansversNumber = _lodash2.default.get(res1, 'body.items.length');
